					...
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>901, Titanium Square, Thaltej, Ahmedabad, Gujarat, India</li>
								<li><i class="icon-phone2"></i>+91 - 9898989898 </li>
								<li><i class="icon-mail"></i><a href="#">info@guideman.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.Guideman .com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
